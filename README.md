...
## 🚀 Live Deployment
**Live API Endpoint (Swagger UI):** [https://earphone-state-glove.ngrok-free.dev/docs](https://earphone-state-glove.ngrok-free.dev/docs)
*(Note: Hosted via secure ngrok tunnel for evaluation purposes).*
